...
†: Co-first Author
 <!-- 引文为NLM格式 -->
1. **<u>He Z</u>**, Sun Y, Li H, Sun C, Yang X, Chen H, Liao M, Bo X. CLAMP: predicting specific protein-mediated chromatin loops in diverse species with a chromatin accessibility language model. **_Genome Biol_**. 2026 Jan; doi: [10.1186/s13059-026-03948-9](https://doi.org/10.1186/s13059-026-03948-9). (IF=17.9, JCR Q1)
...
5. Wang C, **<u>He Z</u>**, Jia R, Pan S, Coin LJ, Song J, Li F. PLANNER: a multi-scale deep language model for the origins of replication site prediction. **_IEEE J Biomed Health Inform_**. 2024 Jan 4;PP. doi: [10.1109/JBHI.2024.3349584](https://doi.org/10.1109/JBHI.2024.3349584). (IF=7.7, JCR Q1)
